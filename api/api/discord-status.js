// Discord presence via Lanyard. Each id is only monitored by one instance -
// 300137175238836225 is in larpyard's guild but not discord.gg/lanyard;
// 1352866897900732446 is the reverse - so every id tries the self-hosted
// larpyard.arshnah.in first and falls back to the public api.lanyard.rest.
...
async function best() {
  ...
  const presences = results.filter(Boolean);
